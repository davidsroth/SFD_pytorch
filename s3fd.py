...
class s3fd(nn.Module):
    def __init__(self):
        ...
        self.conv3_3_norm_mbox_gender = nn.Conv2d(256, 4, kernel_size=3, stride=1, padding=1)
        ...
        self.conv6_gender = nn.Conv2d(512, 2, kernel_size=3, stride=1, padding=1)
    ...
    def forward(self, x):
        ...
        gen1 = self.conv3_3_norm_mbox_gender(f3_3)
        ...
        gen3 = self.conv5_3_norm_gender(f4_3)
        ...
        # #max-out gender label
        chunk = torch.chunk(gen1,4,1)
        bmax  = torch.max(torch.max(chunk[0],chunk[1]),chunk[2])
        gen1  = torch.cat([bmax,chunk[3]],dim=1)

        #return [cls1,reg1,cls2,reg2,cls3,reg3,cls4,reg4,cls5,reg5,cls6,reg6]
        #return [cls1,cls2,cls3,cls4,cls5,cls6]

        out = [cls1,gen1,cls2,gen2,cls3,gen3,cls4,gen4,cls5,gen5,cls6,gen6]
        # for item in out:
        #     print (item.size())
